...
@pytest.mark.parametrize(("nmea_str", "expected_type", "value_name", "expected_value"), (
        ...
        ("$WIMWV,281,R,7.2,N,A*34",                                                         nmea_datagram.WindSpeedAndAngle,          "speed_knots", 7.2),
        ("$IIVHW,245.1,T,245.1,M,23.01,N,000.01,K",                                         nmea_datagram.SpeedThroughWater,          "speed_knots", 23.01)
))
